...
{
    using Vector3 = detail::Vector3_<float> ;
//class Vector3
//{
//  public:
...
//};
    ...
    using Matrix3 = detail::Matrix3x3_<float> ;
//class Matrix3
//{
//  public:
...
class Gamut
{
  public:
    ...
    constexpr Gamut(const Matrix3 &fromXYZ) : toXYZ_(~fromXYZ), fromXYZ_(fromXYZ)
    {
        ;
    }
...
static constexpr Matrix3 Bradford(const Tristimulus &white_src, const Tristimulus &white_dst)
{
    ...
    const Matrix3      scale(
                ...
                lms_dst[1] / lms_src[1],
                lms_dst[2] / lms_src[2]) ;
    return LMS.toXYZ() * scale * LMS.fromXYZ();
}
